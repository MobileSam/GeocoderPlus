...
public class Geocoder {
    ...
    public void setBounds(double northeastLatitude, double northeastLongitude, double southWestLatitude,
            double southWestLongitude) {
        this.mNortheastLatitude = northeastLatitude;
        this.mNortheastLongitude = northeastLongitude;
        this.mSouthWestLatitude = southWestLatitude;
        this.mSouthWestLongitude = southWestLongitude;
    ...
    public List<Address> getFromLocationName(String locationName, int maxResults) throws IllegalArgumentException,
            IOException {
        // Declare
    ...
    private String getGeocodingUrl(String locationName) {
        ...
        if (mUseBounds) {
            String bounds = mNortheastLatitude + "," + mNortheastLongitude + "|" + mSouthWestLatitude + ","
                    + mSouthWestLongitude;
            params.add(new BasicNameValuePair(PARAM_BOUNDS, bounds));
        }
